...
const ListComponent = ({genre,index}:any) => {
    return (
        <li className= {` group hover:bg-[#22e5de] p-[4px] border-[1px] ${index == 1 && 'border-t-0'} first:border-none border-b-0 nth-child(2) border-r-0 odd:border-l-0 overflow-hidden text-ellipsis flex items-center`}
      >
            <Link href='/header' 
