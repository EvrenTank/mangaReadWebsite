...
const ChapterListElement = ({mangaName,episodeNumber,episodeName,okunmaSayisi,eklenmeTarihi}:any) => {
    return (
        <li className=" group h-[42px] leading-[42px] text-white rounded-[5px] relative">
            <Link href={`/manga/${mangaName}/${episodeNumber}/1`} className="text-[12px] flex items-center rounded-[5px] max-[550px]:text-[9px] ">
                ...
                <span className="group-hover:bg-[#97A6E4] inline-block text-ellipsis   bg-[#c0c7e3]">{episodeName}</span>
